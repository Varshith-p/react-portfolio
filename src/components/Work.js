      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 m-auto md:my-20 md:px-8 lg:px-16 gap-16 lg:gap-14">
        <div className="bg-white shadow-md p-3 rounded-md">
          ...
          <div className="flex gap-3 items-center pt-2 text-lg">
            ...
            <a href="https://fundmeblockchain.vercel.app/" target="_blank">
              <BiLink />
            </a>
          </div>
          <div>
        ...
        <div className="bg-white shadow-md p-3 rounded-md">
          ...
          <div className="flex gap-3 items-center pt-2 text-lg">
            ...
            <a href="https://varshith-portfolio.vercel.app/" target="_blank">
              <BiLink />
            </a>
          </div>
          <div>
            <span className="font-medium">Technologies:</span> HTML, CSS, JS,
            React.js
          </div>
        </div>
      </div>
